...
2. **View Dashboard**: Access your cloud dashboard at [https://arms.elsaifoundry.ai/dashboard](https://arms.elsaifoundry.ai/dashboard)
3. **Check Metrics**: Review agent performance, token usage, and costs
...
- Check the [Configuration Guide](./getting-started/configuration) for dashboard setup
